...
(check-equal? (add (make-rational 2 3) (make-rational 1 2)) (make-rational 7 6))
(check-equal? (add (make-complex-from-real-imag 2 3) (make-complex-from-mag-ang 3 pi)) (make-complex-from-real-imag -1.0 3.0000000000000004))

;2.77
(let ([z (make-complex-from-real-imag 3 4)])
  (check-equal? (magnitude-custom z) 5))
